...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#aname").keydown(function(event){
			if(event.keyCode == 13){
				// 表示已按下回车键，展现完列表后，记得将模态窗口默认的回车行为禁用掉
				$.ajax({
					url: "workbench/clue/getActivityListByNameAndNotClueId.do",
					type: "get",
					data: {
					...
					success: function(data){
						...
						$.each(data,function(index,element){
							html += '<tr>';
							html += '<td><input type="checkbox" name="xz" id="'+element.id+'"/></td>';
		...
		$("#bundBtn").click(function(){
			...
			if($xz.length == 0){
				...
				// 勾选了一条或者，多条
				// /workbench/clue/bund.do?clueId={requestScope.clue.id}&aId1&aId2
...
<body>
	...
	<div style="position: relative; top: -70px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 50px;">
			...
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${requestScope.clue.createBy}&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">${clue.createTime}</small></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
		<div style="position: relative; left: 40px; height: 30px; top: 60px;">
			<div style="width: 300px; color: gray;">修改者</div>
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${requestScope.clue.editBy}&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">${clue.editTime}</small></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
