...
<script type="text/javascript">
	$(function(){
		...
		// 为创建阶段的下拉框，绑定选中的下拉框事件，根据选中的阶段填写可能性
		$("#create-transactionStage").change(function(){
			// 取得选中的阶段
			var stage = $("#create-transactionStage").val();
			/*
			目标：填写可能性
			阶段有了stage，阶段和可能性之间的对应关系pMap,但是pMap是java语言中的键值对应关系(map)
			我们首先的将pMap转换为js中的键值对关系json
			pMap.put("01资质审查","10") --> var json = {"01资质审查","10"}
			 */
			// alert(stage);
			/*
			我们现在已json.key的形式不能取得value。因为今天的stage是一个可变的变量
			如果是这样的key，那么我们就不能以传统的json.key的形式来取值。我们要使用的取值方式为json[key]
			 */
...
<body>
	...
	<form class="form-horizontal" role="form" id="tranForm" action="workbench/transaction/save.do" method="post" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="云南地区发传单">
				<input type="hidden" value="07606b5bdd424a0d90082aff4e67d73e" id="activityId" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" id="contactsId" value="858e76af5ca04c19bfb3d57a2b178a94" name="contactsId">
			</div>
		</div>
